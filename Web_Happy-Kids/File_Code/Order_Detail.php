                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="systems/ac_order_manager.php?ac=hidden" class="btn btn-danger btn-sm text-right">ลบออเดอร์ที่ยืนยันแล้วทั้งหมด</a>
                                        </div>
                                        <div class="row">
                                            ...
                                            <table class="table table-striped table-borderless">
                                              ...
                                              <tbody>
                                                <?php 
                                                         ...
                                                         INNER JOIN tbl_user ON tbl_cart.ca_user = tbl_user.id WHERE order_status < 4 
                                                         ");
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                      <?php 
                                                        ...
                                                        }elseif ($fet_order->order_status == 3) {
                                                  ...
                                                  <td>
                                                    <?php if ($fet_order->order_status == 1) { ?>
                                                        ...
                                                        <?php }elseif ($fet_order->order_status == 2) {
                                                        ?>
                                                         <a href="systems/ac_order_manager.php?ac=hidden1&order_id=<?php echo $fet_order->order_id;?>" class="btn btn-danger btn-sm text-right">ลบออเดอร์</a>
                                                         <?php }elseif ($fet_order->order_status == 3) {
