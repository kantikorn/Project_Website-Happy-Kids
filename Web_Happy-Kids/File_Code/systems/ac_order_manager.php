       ...
       switch ($_REQUEST['ac']) {
        case 'add':
            ...
            case 'confirm':
                ...
                break;
            case 'hidden':
                $sql = $conn->query("UPDATE tbl_order SET order_status = '4' WHERE order_status = 2 ");
                if ($sql) {
                    echo '<script>
                    setTimeout(function(){
                        swal({
                ...
                break;
            case 'hidden1':
                $sql = $conn->query("UPDATE tbl_order SET order_status = '4' WHERE order_id='".$_REQUEST['order_id']."' ");
                if ($sql) {
                    echo '<script>
                    setTimeout(function(){
                        swal({
